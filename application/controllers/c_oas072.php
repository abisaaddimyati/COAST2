...
* 1.0				 24-02-2015			Metta Kharisma		 +function Download
* 
*
...
class C_OAS072 extends MY_Controller {
	...
	function __construct()
	{
		...
		$this->load->model('m_oas072', 'list_pr_model');		
	}
	function load_view()
	{
	...
	private function get_report_header()
	{
		...
		$header['B2'] = "Purchase Request List";
