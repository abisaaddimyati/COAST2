		...
		<div style="height:100%;
			...
			<table border="0" cellpadding="1" cellspacing="1">
				...
				<tr>
					...
					<td>
						<select id="currency-list-search-name">
				...
				<tr>
					...
					<td colspan="2">
						<button type="submit" class="pull-right btn btn-danger btn-flat btn-slim" id="clear-btn" onclick="change_page(this, 'c_oas047/<?php if (isset($readonly))echo'load_view_read_only'; else echo'load_view'?>');">Clear</button>
						<button type="button" class="pull-right btn btn-success btn-flat btn-slim" id="search-btn" onclick="doSearchCurrencyList(this);">Search</button>
					</td>
				</tr>
		...
		<tbody style="height: 10px; overflow: scroll;">
				...
				<tr class="active">
					...
					<td class="text-center">
						<?php if (!isset($readonly)) { ?>
						<a href="#" rel="detail" class="opt edit" title="Edit" onclick="form_dialog('EDIT SETTING LIMIT TO DIRECTOR', 'c_oas051/load_edit_form/<?php echo $user["ccid"]; ?>')"></a>
						<?php }else{ ?>
						<a href="#" rel="detail" class="opt detail" title="Datail" onclick="form_dialog('SETTING LIMIT TO DIRECTOR INFO', 'c_oas051/load_read_only/<?= $user['ccid'] ?>')"></a>
						<?php } ?>
					</td>
...
<script type="text/javascript">
	function doSearchCurrencyList(elm)
	{
		
		var currencyid  = $('#currency-list-search-name').val();
		

		var url="c_oas047/search?";
		<?php if (isset($readonly)){ ?>
			url="c_oas047/search_readonly?";
		<?php } ?>
